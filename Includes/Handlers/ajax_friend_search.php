...
// Messages.php - New message function when searching through friends.
// Message is called from messages.php to demo.js function getUser() to here which is then returned with a list of friends
